...
@section('content')
    ...
    <div class="section section-head" id="apps" style="background-image: url('{{ asset('uploads/themes/'.$theme->apps_bg) }}');">
                        ...
                        <div class=" col-sm-6  col-md-4 col-lg-2 ">
                            <div class="app-wrap">
                                <a href="{{ action('WorkController@show',$app->id) }}">
                                    <div class="app-icon" style="background-image: url({{ asset('uploads/works/thumb_'.$app->img_square) }});"> </div>
                                    <h4 class="app-title">{!! $app->newApp() !!} {{ $app->titulo}}</h4>
                                </a>
                    ...
                    <div class=" col-sm-6  col-md-4 col-lg-3 ">
                        <div class="anim-wrap">
                            <a href="{{ action('WorkController@show',$anim->id) }}">
                                <div class="anim-image" style="background-image: url({{ asset('uploads/works/thumb_'.$anim->img_horizontal )}});"> </div>
                    ...
                    <div class=" col-sm-3  col-md-3 col-lg-2 ">
                        <div class="dis-wrap">
                            <a href="{{ action('WorkController@show',$diseño->id) }}">
                                <div class="dis-image" style="background-image: url({{ asset('uploads/works/thumb_'.$diseño->img_vertical) }});"> </div>
